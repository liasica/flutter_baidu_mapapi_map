...
extension BMFPolygonUpdateExtension on BMFPolygon {
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> coordinates) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updatePolygonMember(this.methodChannel, {'id': this.id, 'member': 'coordinates', 'value': coordinates.map((coordinate) => coordinate.toMap()).toList()});
  ...
  Future<bool> updateWidth(int width) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolygonMember(this.methodChannel, {'id': this.id, 'member': 'width', 'value': width});
  ...
  Future<bool> updateStrokeColor(Color strokeColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolygonMember(this.methodChannel, {'id': this.id, 'member': 'strokeColor', 'value': strokeColor.value.toRadixString(16)});
  ...
  Future<bool> updateFillColor(Color fillColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolygonMember(this.methodChannel, {'id': this.id, 'member': 'fillColor', 'value': fillColor.value.toRadixString(16)});
  ...
  Future<bool> updateLineDashType(BMFLineDashType lineDashType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolygonMember(this.methodChannel, {'id': this.id, 'member': 'lineDashType', 'value': lineDashType.index});
  ...
  Future<bool> updateHollowShapes(List<BMFHollowShape> hollowShapes) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updatePolygonMember(this.methodChannel, {'id': this.id, 'member': 'hollowShapes', 'value': hollowShapes.map((e) => e.toMap()).toList()});
