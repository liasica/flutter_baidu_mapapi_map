...
import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFCoordinate, ColorUtil;
...
class BMFPolyline extends BMFOverlay implements BMFOverlayBoundsInterface {
  ...
  BMFPolyline.fromMap(Map map)
    ...
    lineDirectionCross180 = BMFLineDirectionCross180Type.values[map['lineDirectionCross180'] as int];
  ...
  Future<BMFCoordinateBounds?> get bounds async {
    return await BMFMapDispatcherFactory.instance.overlayDispatcher.getBounds(this);
  }
}
...
extension BMFPolylineUpdate on BMFPolyline {
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> coordinates, {List<int>? indexs}) async {
    ArgumentError.checkNotNull(coordinates, "coordinates");

    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(
        this.methodChannel, {'id': this.id, 'member': 'coordinates', 'value': coordinates.map((coordinate) => coordinate.toMap()).toList(), 'indexs': indexs?.map((index) => index).toList()});
  ...
  Future<bool> updateWidth(int width) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'width', 'value': width});
  ...
  Future<bool> updateIndexs(List<int> indexs) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'indexs', 'value': indexs.map((index) => index).toList()});
  ...
  Future<bool> updateColors(List<Color> colors, {List<int>? indexs}) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(
        this.methodChannel, {'id': this.id, 'member': 'colors', 'value': colors.map((color) => color.value.toRadixString(16)).toList(), 'indexs': indexs?.map((index) => index).toList()});
  ...
  Future<bool> updateTextures(List<String> textures) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'textures', 'value': textures.map((e) => e).toList()});
  ...
  Future<bool> updateDottedLine(bool dottedLine) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'dottedLine', 'value': dottedLine});
  ...
  Future<bool> updateLineDashType(BMFLineDashType lineDashType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineDashType', 'value': lineDashType.index});
  ...
  Future<bool> updateLineCapType(BMFLineCapType lineCapType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineCapType', 'value': lineCapType.index});
  ...
  Future<bool> updateLineJoinType(BMFLineJoinType lineJoinType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineJoinType', 'value': lineJoinType.index});
  ...
  Future<bool> updateClickable(bool clickable) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'clickable', 'value': clickable});
  ...
  Future<bool> updateIsKeepScale(bool isKeepScale) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'isKeepScale', 'value': isKeepScale});
  ...
  Future<bool> updateIsFocus(bool isFocus) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'isFocus', 'value': isFocus});
  ...
  Future<bool> updateVisible(bool visible) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'visible', 'value': visible});
  ...
  Future<bool> updateZIndex(int zIndex) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'zIndex', 'value': zIndex});
  ...
  Future<bool> updateThined(bool isThined) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'isThined', 'value': isThined});
  ...
  Future<bool> updateLineDirectionCross180(BMFLineDirectionCross180Type lineDirectionCross180) async {
    ArgumentError.checkNotNull(lineDirectionCross180, "lineDirectionCross180");

    bool ret =
        await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineDirectionCross180', 'value': lineDirectionCross180.index});
  ...
  Future<bool> updateLineBloomGradientASPeed(double lineBloomGradientASPeed) async {
    bool ret =
        await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineBloomGradientASPeed', 'value': lineBloomGradientASPeed});
  ...
  Future<bool> updateLineBloomMode(BMFLineBloomMode lineBloomMode) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineBloomMode', 'value': lineBloomMode.index});
  ...
  Future<bool> updateLineBloomWidth(double lineBloomWidth) async {
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineBloomWidth', 'value': lineBloomWidth});
  ...
  Future<bool> updateLineBloomAlpha(double lineBloomAlpha) async {
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineBloomAlpha', 'value': lineBloomAlpha});
  ...
  Future<bool> updateLineBloomBlurTimes(int lineBloomBlurTimes) async {
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePolylineMember(this.methodChannel, {'id': this.id, 'member': 'lineBloomBlurTimes', 'value': lineBloomBlurTimes});
