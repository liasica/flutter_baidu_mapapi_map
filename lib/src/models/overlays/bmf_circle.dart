...
import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFCoordinate, ColorUtil, BMFCoordinateBounds;
...
extension BMFCircleUpdateExtension on BMFCircle {
  ...
  Future<bool> updateCenter(BMFCoordinate center) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'center', 'value': center.toMap()});
  ...
  Future<bool> updateRadius(double radius) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'radius', 'value': radius});
  ...
  Future<bool> updateWidth(int width) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'width', 'value': width});
  ...
  Future<bool> updateStrokeColor(Color strokeColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'strokeColor', 'value': strokeColor.value.toRadixString(16)});
  ...
  Future<bool> updateFillColor(Color fillColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'fillColor', 'value': fillColor.value.toRadixString(16)});
  ...
  Future<bool> updateLineDashType(BMFLineDashType lineDashType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'lineDashType', 'value': lineDashType.index});
  ...
  Future<bool> updateDottedLine(bool dottedLine) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'dottedLine', 'value': dottedLine});
  ...
  Future<bool> updateHollowShapes(List<BMFHollowShape> hollowShapes) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updateCircleMember(this.methodChannel, {'id': this.id, 'member': 'hollowShapes', 'value': hollowShapes.map((e) => e.toMap()).toList()});
