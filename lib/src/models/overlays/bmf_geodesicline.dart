...
extension BMFGeodesicLineUpdateExtension on BMFGeodesicLine {
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> coordinates) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updateGeodesicLineMember(this.methodChannel, {'id': this.id, 'member': 'coordinates', 'value': coordinates.map((coordinate) => coordinate.toMap()).toList()});
  ...
  Future<bool> updateWidth(int width) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGeodesicLineMember(this.methodChannel, {'id': this.id, 'member': 'width', 'value': width});
  ...
  Future<bool> updateStrokeColor(Color strokeColor) async {
    ...
    bool ret =
        await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGeodesicLineMember(this.methodChannel, {'id': this.id, 'member': 'strokeColor', 'value': strokeColor.value.toRadixString(16)});
  ...
  Future<bool> updateTextureImage(String textureImage) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGeodesicLineMember(this.methodChannel, {'id': this.id, 'member': 'textureImage', 'value': textureImage});
  ...
  Future<bool> updateLineDashType(BMFLineDashType lineDashType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGeodesicLineMember(this.methodChannel, {'id': this.id, 'member': 'lineDashType', 'value': lineDashType.index});
  ...
  Future<bool> updateLineDirectionCross180(BMFLineDirectionCross180Type lineDirectionCross180) async {
    ...
    bool ret =
        await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGeodesicLineMember(this.methodChannel, {'id': this.id, 'member': 'lineDirectionCross180', 'value': lineDirectionCross180.index});
