...
class BMFMarker extends BMFOverlay {
  ...
  BMFMarker.fromMap(Map map)
    ...
    screenPointToLock = map['screenPointToLock'] == null ? null : BMFPoint.fromMap(map['screenPointToLock']);
    identifier = map['identifier'];
    icon = map['icon'];
    centerOffset = map['centerOffset'] == null ? null : BMFPoint.fromMap(map['centerOffset']);
    ...
    hidePaopaoWhenTwoFingersTapOnMap = map['hidePaopaoWhenTwoFingersTapOnMap'] as bool?;
    ...
    isOpenCollisionDetectionWithMapPOI = map['isOpenCollisionDetectionWithMapPOI'] as bool?;
    isOpenCollisionDetectionWithPaoPaoView = map['isOpenCollisionDetectionWithPaoPaoView'] as bool?;
  ...
  Map<String, Object?> toMap() {
    return Map.from(super.toMap())
      ..addAll({
        ...
        'isOpenCollisionDetectionWithMapPOI': this.isOpenCollisionDetectionWithMapPOI,
...
extension BMFMarkerUpdateExtension on BMFMarker {
  ...
  Future<bool> updateTitle(String title) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.markerDispatcher.updateMarkerMember(this.methodChannel, {
      'id': this.id,
      'member': 'title',
      'value': title,
    });
  ...
  ///
  /// iOS独有
  Future<bool> updateIsLockedToScreen(bool isLockedToScreen, BMFPoint? screenPointToLock) async {
    if (!Platform.isIOS) {
      return false;
    }
    bool ret = await BMFMapDispatcherFactory.instance.markerDispatcher.updateMarkerMember(
        this.methodChannel, {'id': this.id, 'member': 'isLockedToScreen', 'value': isLockedToScreen, 'screenPointToLock': screenPointToLock == null ? null : screenPointToLock.toMap()});
