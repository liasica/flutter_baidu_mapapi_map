...
extension BMFArcLineUpdateExtension on BMFArcLine {
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> coordinates) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updateArclineMember(this.methodChannel, {'id': this.id, 'member': 'coordinates', 'value': coordinates.map((coordinate) => coordinate.toMap()).toList()});
  ...
  Future<bool> updateWidth(int width) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateArclineMember(this.methodChannel, {'id': this.id, 'member': 'width', 'value': width});
  ...
  Future<bool> updateColor(Color color) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateArclineMember(this.methodChannel, {'id': this.id, 'member': 'color', 'value': color.value.toRadixString(16)});
  ...
  Future<bool> updateLineDashType(BMFLineDashType lineDashType) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateArclineMember(this.methodChannel, {'id': this.id, 'member': 'lineDashType', 'value': lineDashType.index});
