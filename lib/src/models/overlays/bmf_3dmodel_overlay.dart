import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFModel, BMFCoordinate;
...
extension BMF3DModelOverlayUpdateExtension on BMF3DModelOverlay {
  ...
  Future<bool> updateOption(BMF3DModelOption option) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.update3DModelOverlayMember(this.methodChannel, {'id': this.id, 'member': 'option', 'value': option.toMap()});
  ...
  Future<bool> updateCenter(BMFCoordinate center) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.update3DModelOverlayMember(this.methodChannel, {'id': this.id, 'member': 'center', 'value': center.toMap()});
  ...
  ///
  /// [BMFCoordinate] center 中心点
  Future<bool> updateOptionAndCenter({required BMF3DModelOption option, required BMFCoordinate center}) async {
    ArgumentError.checkNotNull(option, "option");
    ArgumentError.checkNotNull(center, "center");

    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.update3DModelOverlayMember(this.methodChannel, {
      'id': this.id,
