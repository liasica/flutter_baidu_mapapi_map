...
import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFModel, BMFCoordinate, ColorUtil, BMFCoordinateBounds;
...
class BMFTraceOverlay extends BMFOverlay implements BMFOverlayBoundsInterface {
  ...
  BMFTraceOverlay.fromMap(Map map)
    ...
    traceOverlayAnimateOption = BMFTraceOverlayAnimateOption.formMap(map['traceOverlayAnimateOption']);
  ...
  Map<String, Object?> toMap() {
    return Map.from(super.toMap())
      ..addAll({
        ...
        'strokeColors': this.strokeColors?.map((color) => color.value.toRadixString(16)).toList(),
      });
  }
...
class BMFTraceOverlayAnimateOption implements BMFModel {
  ...
  BMFTraceOverlayAnimateOption.formMap(Map map) : assert(map != null) // ignore: unnecessary_null_comparison
  {
    ...
    easingCurve = BMFTraceOverlayAnimationEasingCurve.values[map['easingCurve'] as int];
