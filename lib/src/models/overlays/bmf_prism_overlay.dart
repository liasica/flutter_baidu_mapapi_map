...
import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFCoordinate, ColorUtil, BMFBuildInfo;
...
class BMFPrismOverlay extends BMFOverlay {
  ...
  BMFPrismOverlay.fromMap(Map map)
    ...
    buildInfo = (map['buildInfo'] == null ? null : BMFBuildInfo.fromMap(map['buildInfo']));
...
extension BMFPrismOverlayUpdateExtension on BMFPrismOverlay {
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> coordinates) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updatePrismOverlayMember(this.methodChannel, {'id': this.id, 'member': 'coordinates', 'value': coordinates.map((coordinate) => coordinate.toMap()).toList()});
  ...
  Future<bool> updateBuildInfo(BMFBuildInfo buildInfo) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePrismOverlayMember(this.methodChannel, {'id': this.id, 'member': 'buildInfo', 'value': buildInfo.toMap()});
  ...
  Future<bool> updateTopFaceColor(Color topFaceColor) async {
    ...
    bool ret =
        await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePrismOverlayMember(this.methodChannel, {'id': this.id, 'member': 'topFaceColor', 'value': topFaceColor.value.toRadixString(16)});
  ...
  Future<bool> updateSideFaceColor(Color sideFaceColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher
        .updatePrismOverlayMember(this.methodChannel, {'id': this.id, 'member': 'sideFaceColor', 'value': sideFaceColor.value.toRadixString(16)});
  ...
  Future<bool> updateSideFacTexture(String sideFacTexture) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePrismOverlayMember(this.methodChannel, {'id': this.id, 'member': 'sideFacTexture', 'value': sideFacTexture});
  ...
  Future<bool> updateFloorHeight(double floorHeight) async {
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updatePrismOverlayMember(this.methodChannel, {'id': this.id, 'member': 'floorHeight', 'value': floorHeight});
