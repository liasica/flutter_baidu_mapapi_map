...
extension BMFGradientLineUpdateExtension on BMFGradientLine {
  ...
  Future<bool> updateCoordinates(List<BMFCoordinate> coordinates, {List<int>? indexs}) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGradientLineMember(
  ...
  Future<bool> updateWidth(int width) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGradientLineMember(this.methodChannel, {'id': this.id, 'member': 'width', 'value': width});
  ...
  Future<bool> updateThined(bool isThined) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGradientLineMember(this.methodChannel, {'id': this.id, 'member': 'isThined', 'value': isThined});
  ...
  Future<bool> updateLineDirectionCross180(BMFLineDirectionCross180Type lineDirectionCross180) async {
    ...
    bool ret =
        await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGradientLineMember(this.methodChannel, {'id': this.id, 'member': 'lineDirectionCross180', 'value': lineDirectionCross180.index});
