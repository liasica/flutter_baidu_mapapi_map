...
import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFModel, BMFCoordinate, ColorUtil;
...
class BMFText extends BMFOverlay {
  ...
  BMFText.fromMap(Map map)
    ...
    typeFace = map['typeFace'] == null ? null : BMFTypeFace.fromMap(map['typeFace']);
    alignX = map['alignX'];
    alignY = map['alignY'];
    rotate = map['rotate'];
...
extension BMFTextUpdateExtension on BMFText {
  ...
  Future<bool> updateText(String text) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'text', 'value': text});
  ...
  Future<bool> updatePosition(BMFCoordinate position) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'position', 'value': position.toMap()});
  ...
  Future<bool> updateBgColor(Color bgColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'bgColor', 'value': bgColor.value.toRadixString(16)});
  ...
  Future<bool> updateFontColor(Color fontColor) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'fontColor', 'value': fontColor.value.toRadixString(16)});
  ...
  Future<bool> updateTypeFace(BMFTypeFace typeFace) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'typeFace', 'value': typeFace.toMap()});
  ...
  Future<bool> updateFontSize(int fontSize) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'fontSize', 'value': fontSize});
  ...
  Future<bool> updateAlign(int alignX, int alignY) async {
    ...
    if (alignX != BMFHorizontalAlign.ALIGN_CENTER_HORIZONTAL && alignX != BMFHorizontalAlign.ALIGN_LEFT && alignX != BMFHorizontalAlign.ALIGN_RIGHT) {
      return false;
    }

    if (alignY != BMFVerticalAlign.ALIGN_BOTTOM && alignY != BMFVerticalAlign.ALIGN_CENTER_VERTICAL && alignY != BMFVerticalAlign.ALIGN_TOP) {
      return false;
    }

    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'align', 'alignX': alignX, 'alignY': alignY});
    if (ret) {
      this.alignX = alignX;
      this.alignY = alignY;
    }
  ...
  Future<bool> updateRotate(double rotate) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'rotate', 'value': rotate});
    if (ret) {
      this.rotate = rotate;
    }
    return ret;
  ...
  Future<bool> updateParagraphSpacing(double paragraphSpacing) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'paragraphSpacing', 'value': paragraphSpacing});
    if (ret) {
  ...
  Future<bool> updateMaxLineWidth(int maxLineWidth) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'maxLineWidth', 'value': maxLineWidth});
    if (ret) {
  ...
  Future<bool> updateLineSpacing(int lineSpacing) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'lineSpacing', 'value': lineSpacing});
    if (ret) {
  ...
  Future<bool> updateAlignment(BMFTextAlignment alignment) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'alignment', 'value': alignment.index});
    if (ret) {
  ...
  Future<bool> updateLineBreakMode(BMFTextLineBreakMode lineBreakMode) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'lineBreakMode', 'value': lineBreakMode.index});
    if (ret) {
  ...
  Future<bool> updateStartLevel(int startLevel) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'startLevel', 'value': startLevel});
    if (ret) {
  ...
  Future<bool> updateEndLevel(int endLevel) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateTextMember(this.methodChannel, {'id': this.id, 'member': 'endLevel', 'value': endLevel});
    if (ret) {
