import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFModel, BMFCoordinate, BMFSize, BMFPoint;
...
class BMFMultiPointItem implements BMFModel {
  ...
  @override
  Map<String, Object?> toMap() {
    return {'coordinate': this.coordinate.toMap(), 'title': this.title, 'subtitle': this.subtitle};
  }
