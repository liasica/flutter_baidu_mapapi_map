...
extension BMFDotUpdateExtension on BMFDot {
  ...
  Future<bool> updateCenter(BMFCoordinate center) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateDotMember(this.methodChannel, {'id': this.id, 'member': 'center', 'value': center.toMap()});
  ...
  Future<bool> updateRadius(double radius) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateDotMember(this.methodChannel, {'id': this.id, 'member': 'radius', 'value': radius});
  ...
  Future<bool> updateColor(Color color) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateDotMember(this.methodChannel, {'id': this.id, 'member': 'color', 'value': color.value.toRadixString(16)});
