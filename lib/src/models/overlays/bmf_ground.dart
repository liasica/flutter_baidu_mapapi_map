import 'package:flutter_baidu_mapapi_base/flutter_baidu_mapapi_base.dart' show BMFCoordinate, BMFCoordinateBounds;
...
class BMFGround extends BMFOverlay {
  ...
  Future<bool> updatePosition(BMFCoordinate position) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {'id': this.id, 'member': 'position', 'value': position.toMap()});
  ...
  Future<bool> updateAnchorX(double anchorX) async {
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {'id': this.id, 'member': 'anchorX', 'value': anchorX});
  ...
  Future<bool> updateAnchorY(double anchorY) async {
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {'id': this.id, 'member': 'anchorY', 'value': anchorY});
  ...
  Future<bool> updateDimensions(double width, double height) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {
      'id': this.id,
      'member': 'dimensions',
      'width': width,
      'height': height,
  ...
  Future<bool> updateBounds(BMFCoordinateBounds bounds) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {'id': this.id, 'member': 'bounds', 'value': bounds.toMap()});
  ...
  Future<bool> updateImage(String image) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {'id': this.id, 'member': 'image', 'value': image});
  ...
  Future<bool> updateTransparency(double transparency) async {
    ...
    bool ret = await BMFMapDispatcherFactory.instance.overlayDispatcher.updateGroundMember(this.methodChannel, {'id': this.id, 'member': 'transparency', 'value': transparency});
